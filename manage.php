...
$providers = TeConnect_Plugin::options();
$db = Typecho_Db::get();
$uid = $this->user->uid;
// 查询该用户所有绑定
...
<head>
    ...
    <title>第三方登录设置 - TeConnect</title>
    <link rel="stylesheet" href="/usr/plugins/TeConnect/else/bootstrap.min.css"/>
    <style>
        :root {
            --bg: #f6f7fb;
            --card-bg: #fff;
                    ...
                    <div class="provider-card" style="border-left: 4px solid <?php echo htmlspecialchars($brand); ?>">
                        <div class="provider-head">
                            <div class="provider-meta">
                                <img src="/usr/plugins/TeConnect/login_ico/<?php echo htmlspecialchars($type); ?>.png" alt="<?php echo htmlspecialchars($type); ?>">
